...
export default function UploadFilterbdoCSV() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      xhr.open("POST", "/api/upload/routebdocsv", true);
      ...
      xhr.onload = () => {
        ...
        if (xhr.status === 200) {
          setMessage("✅ Arquivo recebido e filtrado com sucesso!");
          reset();
        } else {
  ...
  return (
    ...
    <div className="p-4 border rounded-lg shadow-md">
      <h2 className="text-lg font-bold mb-2">Upload de CSV da Base de Dados de Operadoras</h2>
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <button
          ...
          disabled={isLoading}
        >
          {isLoading ? "Enviando..." : "Filtrar CSV"}
        </button>
      </form>
      ...
      {isProcessing && <p className="mt-2 text-sm text-blue-600">⏳ Filtrando arquivo...</p>}
