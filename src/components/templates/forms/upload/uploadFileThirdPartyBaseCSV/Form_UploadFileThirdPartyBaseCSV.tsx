...
export default function UploadFileThirdPartyBaseCSV() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      xhr.open("POST", "/api/upload/routebdtcsv", true);
  ...
  return (
    <div className="p-4 border rounded-lg shadow-md">
      <h2 className="text-lg font-bold mb-2">Upload de CSV da Base de Terceiros</h2>
