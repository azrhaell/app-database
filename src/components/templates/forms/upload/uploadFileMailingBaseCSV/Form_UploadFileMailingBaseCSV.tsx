...
export default function UploadFileMailingBaseCSV() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      xhr.open("POST", "/api/upload/routebdmailingcsv", true);
  ...
  return (
    <div className="p-4 border rounded-lg shadow-md">
      <h2 className="text-lg font-bold mb-2">Upload de CSV Mailing Anatel</h2>
